...
namespace Mozzafiato.Areas.Admin.Controllers
{
    ...
    public class AdminPedidosController : Controller
    {
        ...
        public async Task<IActionResult> Index(string filter, int pageindex = int.MinValue, string sort = "Nome")
        {
            ...
            //nao descobri como ordenar e esse codigo que deveria fazer isso não faz absolutamente nada, mas dentro da lista faz, n da pra entender como web funciona
            resultado = resultado.OrderByDescending(x => x.PedidoEnviado);
        ...
        public async Task<IActionResult>
            Create([Bind(@"PedidoId,
                           ...
                           Email,
                           PedidoEnviado,
                           PedidoEntregueEm")] Pedido pedido)
        {
